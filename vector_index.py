...
class VectorIndex:
    def __init__(self, distance_metric: str = "cosine", embedding_fn=None):
        ...
        Args:
            distance_metric: Similarity measure to use — 'cosine' or
                             'euclidean'.
    ...
    def add_document(self, document: Dict[str, Any]):
        ...
        Args:
            document: Dict that must contain a 'content' key with a string
                      value. Any extra keys are stored alongside the vector and
